package com.minkon.board.filter;
...
public class JwtAuthenticationFilter  extends OncePerRequestFilter {
    ...
    // request가 들어왔을 때 Request Header의 Authorization 필드의 Bearer Token값을 가져옵니다.
